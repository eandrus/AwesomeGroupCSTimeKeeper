        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CreatedBy = table.Column<string>(maxLength: 65, nullable: true),
                    Name = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMember_Project_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Project",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_GroupMember_StudentCourse_StudentCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Justification = table.Column<string>(maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeEntry_GroupMember_GroupMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeEntryChange", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeEntryChange_TimeEntry_TimeEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMember_ProjectId",
                table: "GroupMember",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupMember_StudentCourseId",
                table: "GroupMember",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeEntry_GroupMemberId",
                table: "TimeEntry",
                column: "GroupMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeEntryChange_TimeEntryId",
